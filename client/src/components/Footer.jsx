...
const Footer = () => {
  return (
    <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 mt-20 w-full text-gray-500">
...
Transform your content creation with our suite of premium AI tools. Write articles, generate images, and enhance your workflow.
            ...
            <div>
                ...
                <div className="text-sm space-y-2">
                    ...
                    <div className="flex items-center gap-2 pt-4">
                        ...
                        <button className="bg-primary w-24 max-sm:w-36 h-9 text-white rounded  cursor-pointer">Subscribe</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 © SDKING DEV. All Right Reserved.
    </p>
</footer>
  )
}
